...
//                   <span className="text-danger">
//                     {errors.canonicalLink.message as string}
//                   </span>
//                 )}
//               </FormGroup>
...
//                 {errors.robotsText && (
//                   <span className="text-danger">
//                     {errors.robotsText.message as string}
//                   </span>
//                 )}
//               </FormGroup>
...
//                 {errors.focusKeyword && (
//                   <span className="text-danger">
//                     {errors.focusKeyword.message as string}
//                   </span>
//                 )}
//               </FormGroup>
//               <FormGroup>
...
//                   <span className="text-danger">
//                     {errors.parentServiceName.message as string}
//                   </span>
//                 )}
//               </FormGroup>
//             </TabPane>
