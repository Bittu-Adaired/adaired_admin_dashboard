...
//     await handleConfirmDelete(id); // Delete the selected item
//     setShowConfirmToast(false); // Close the toast after confirmation
//   };
...
//           toastName={toastName}
//           onConfirm={handleConfirm} // Pass id to handleConfirmDelete
    ...
    <ul className="action simple-list d-flex flex-row space-x-2" key={id}>
      ...
      {showConfirmToast && ( // Conditionally render ConfirmToast
        <ConfirmToast
          message={toastMessage}
          toastName={toastName}
          onConfirm={handleConfirm} // Call handleConfirm on confirmation
          onCancel={() => setShowConfirmToast(false)} // Close toast on cancel
        />
      )}
    </ul>
